...
Both readers retain their established side-by-side Pāli/translation reading body inside the common centred 1080 px maximum page width. Their existing cover images and wording, book text, translations, paragraph order, Contents entries and destinations, footnotes, PCED data, Search and passage-preserving language navigation are preserved. They load shared stylesheet v1.3.20, reader runtime v1.3.19, Paccayaniddeso interface stylesheet v1.0.0, language navigation v1.0.3 and popup runtime v1.3.16. Source and script validation pass; deployed desktop and physical-mobile confirmation remains pending.
