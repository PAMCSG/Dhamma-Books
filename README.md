...
The English reading panel now follows the supplied `TOW for Realization of Nibbā_na - pamc.docx` typography and layout: body and Unicode Pāli use Tahoma (Pāli italic), paragraphs retain the Word first-line and hanging-indent relationships, and headings retain the source small-cap character. All 35 Word tables were audited. The cover layout remains the book cover; twenty complex analytical tables are preserved in eight responsive source-table images; and the remaining fourteen native structures are represented as responsive HTML tables or grids. This restores the source columns for the five aggregates' origination and extinction, six bodies of feeling, four foundations of mindfulness, five hindrances, six opposite characteristic pairs, six wind-element parts, nine kamma-born kalāpas and five jhāna factors, alongside the already structured Noble Eightfold Path, four-elements, body-parts and five-causes/five-effects tables. Desktop retains the Word column arrangement. On mobile, list columns stack as full-width sections, the six opposite pairs form a two-column grid, genuinely wide analytical tables remain contained, and long Pāli compounds wrap within their cells even at an enlarged reader font. The Chinese panel, non-table English passages, Contents, language switching, notes, PCED terms, IDs and shared reader controls are unchanged. Structural validation confirms all table representations, internal English links, reference counts and inline-script syntax; deployed physical-device confirmation remains pending.
