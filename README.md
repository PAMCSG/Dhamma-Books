...
Footnote, PCED and bookmark overlays remain transparent so they never dim the book text, while their panels remain opaque, movable, independently scrollable and last-opened-on-top. Chinese note titles use `註释`. The book loads shared stylesheet and reader JavaScript v1.3.13 and popup runtime v1.3.15. Its established side-by-side Pāli–Chinese reading body, wording, cover image, front matter, paragraph order and alignment, footnotes, Pāli treatment and PCED data are unchanged.
