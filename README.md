...
Both readers retain their approved wider 1500 px desktop container and established side-by-side Pāli/translation reading body. Their existing cover images and wording, book text, translations, paragraph order, Contents entries and destinations, footnotes, PCED data, Search and passage-preserving language navigation are preserved. They load shared stylesheet v1.3.20, reader runtime v1.3.19, Paccayaniddeso interface stylesheet v1.0.0, language navigation v1.0.3 and popup runtime v1.3.16. Source and script validation pass; deployed desktop and physical-mobile confirmation remains pending.
